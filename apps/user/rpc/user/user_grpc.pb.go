...
type UserClient interface {
	Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Respond, error)
...
func (c *userClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Respond, error) {
	out := new(Respond)
...
type UserServer interface {
	Ping(context.Context, *Request) (*Respond, error)
...
func (UnimplementedUserServer) Ping(context.Context, *Request) (*Respond, error) {
